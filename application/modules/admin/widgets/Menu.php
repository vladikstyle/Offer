 ...
 */
class Menu extends \app\widgets\Menu
{
    /**
     * @inheritdoc
     */
    ...
    protected function renderItem($item)
    {
        ...
        if (isset($item['badge']) && $item['badge']) {
            $badge = Yii::$app->formatter->asDecimal($item['badge']);
            $replace['{badge}'] = Html::tag('span', $badge, [
                'class' => 'pull-right label label-' . ($item['badgeClass'] ?? 'primary'),
            ]);
        } else {
            $replace['{badge}'] = '';
        }
