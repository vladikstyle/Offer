...
$this->title = Yii::t('app', 'Update field "{0}"', $model->title);
    ...
    <div class="box-body">
        <div class="profile-field-category-create">
            <?= $this->render('_form', [
                ...
                'fieldClass' => isset($model->field_class) ? $model->field_class : $fieldClass,
                'formAction' =>  Url::to(!empty($fieldClass) ?
                    ['update', 'id' => $model->id, 'fieldClass' => $fieldClass] :
                    ['update', 'id' => $model->id]),
            ]) ?>
        </div>
    </div>
