 ...
 */
class m180917_200001_language extends Migration
{
    /**
    ...
    public function up()
    {
        ...
        $this->createIndex('language_language_idx', '{{%language_translate}}', 'language');

        $this->addForeignKey('language_translate_ibfk_1',
            '{{%language_translate}}', ['language'],
            '{{%language}}', ['language_id'],
            $this->cascade, $this->cascade
        );
        $this->addForeignKey('language_translate_ibfk_2',
