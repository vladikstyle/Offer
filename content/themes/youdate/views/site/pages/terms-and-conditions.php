...
<div class="card">
    <div class="card-body">
        <div class="text-wrap p-lg-6">
            <h2 class="mt-0 mb-4">Terms and Conditions</h2>
            <div class="alert alert-warning">
                <strong>Warning:</strong> You have to change this page by editing this file - <code>content/pages/terms-and-conditions.php</code><br>
                (source file <code>content/themes/youdate/views/site/pages/terms-and-conditions.php</code>)
            </div>
